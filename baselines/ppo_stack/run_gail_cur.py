...
def train(env_id, num_timesteps, seed):
    from baselines.ppo_lift import mlp_policy, pposgd_simple, interactive_ppo, ppo_gail_cur
    ...
    dataset = Mujoco_Dset(expert_path='data/lift_demo.npz', traj_limitation=-1)#interactive_Mujoco_Dset(expert_path='data/lift_demo.npz', traj_limitation=-1)
    reward_giver = TransitionClassifier(env, 100, entcoeff=1e-3)
    ppo_gail_cur.learn(env, curEnv, policy_fn, reward_giver, dataset,
